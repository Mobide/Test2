...
function getNativeLanguages() //http://www.mozilla.org/en-US/firefox/all.html
{
  //http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes
  // important note: you must have the default language as the last item in each major language, after all the en-ca type entries, so en would be last in that case
	$n_languages = array(
	'af' => 'Afrikaans',
	'sq' => 'Shqip',	
	'ar' => 'عربي',
  ...
  //'zh' => '中文',                                 //generic
	...
	'da' => 'Dansk',
	'nl' => 'Nederlands',
	'en' => 'English',	                           //check for en and us
  'eo' => 'Esperanto',
	'et' => 'Eesti keel',
	'fi' => 'suomi',
	'fr' => 'Français',
  ...
  'mk' => 'Македонски',	
	...
	'mn' => 'монгол',
	'ne' => 'नेपाली',
	'nb-no' => 'Norsk bokmål',                    //two
	'nn-no' => 'Norsk nynorsk',                   //two
	//'no' => 'Norsk bokmål',                        //generic
	'or' => 'ଓଡ଼ିଆ',
  'fa' => 'فارسی',
	'pl' => 'Polski',	
	'pt' => 'Português',                            
